 ...
 * for interacting with message actors.
 */
 ...
 * Wraps the RivetKit client with Effect patterns.
 */
...
>() {
	/**
	 * Create a layer with a custom endpoint configuration
	 * @param endpoint - Optional custom endpoint URL
	 */
	static readonly layerConfig = (endpoint?: string): Layer.Layer<ActorsClient> =>
	 ...
	 */
	static readonly Default = ActorsClient.layerConfig()
}
