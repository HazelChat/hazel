 ...
 * - durableStreamUrl: Durable stream server URL for receiving slash commands (defaults to http://localhost:4437)
...
const runtime = createHazelBot({
	...
	durableStreamUrl: process.env.DURABLE_STREAM_URL ?? "http://localhost:4437",
