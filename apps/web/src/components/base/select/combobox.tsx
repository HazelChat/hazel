            ...
            {({ isDisabled }) => (
                <>
                    ...
                    <div className="relative flex w-full items-center gap-2">
                        {inputValue && (
                            <span className="-translate-y-1/2 absolute top-1/2 z-0 inline-flex w-full gap-2 truncate" aria-hidden="true">
                                <p className={cx("font-medium text-md text-primary", isDisabled && "text-disabled")}>{first}</p>
