 ...
 */
export class StreamConflictError extends Schema.TaggedError<StreamConflictError>()(`StreamConflictError`, {
	path: Schema.String,
 ...
 * Invalid JSON error.
 */
export class InvalidJsonError extends Schema.TaggedError<InvalidJsonError>()(`InvalidJsonError`, {
	message: Schema.String,
}) {}
 ...
 */
export class InvalidHeaderError extends Schema.TaggedError<InvalidHeaderError>()(`InvalidHeaderError`, {
 ...
 * Stale epoch error.
 */
export class StaleEpochError extends Schema.TaggedError<StaleEpochError>()(`StaleEpochError`, {
 ...
 * Sequence gap error.
 */
export class SequenceGapError extends Schema.TaggedError<SequenceGapError>()(`SequenceGapError`, {
...
export class InvalidTokenError extends Schema.TaggedError<InvalidTokenError>()(`InvalidTokenError`, {
	message: Schema.optionalWith(Schema.String, { default: () => "Invalid token" }),
}) {}

/**
 * Access denied error (403).
 */
export class AccessDeniedError extends Schema.TaggedError<AccessDeniedError>()(`AccessDeniedError`, {
	message: Schema.optionalWith(Schema.String, { default: () => "Access denied" }),
