...
<Accordions>
  ...
  <Accordion title="Regenerate Compromised Tokens">
    If your webhook token is accidentally exposed, regenerate it immediately from the channel settings. This invalidates the old URL and creates a new one.
  </Accordion>
...
<Cards>
  <Card title="Embeds Reference" href="/docs/webhooks/embeds">
