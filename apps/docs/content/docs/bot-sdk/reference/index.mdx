...
<Cards>
  <Card title="HazelBotClient" href="/docs/bot-sdk/reference/hazel-bot-client">
    Event handlers and message operations
  </Card>
  <Card title="Commands" href="/docs/bot-sdk/reference/commands">
    Command.make and CommandGroup
  </Card>
  <Card title="Configuration" href="/docs/bot-sdk/reference/configuration">
    Environment variables and options
  </Card>
  <Card title="Errors" href="/docs/bot-sdk/reference/errors">
